// cypress/e2e/WPDN/ebupot-unifikasi-GetDetailUploadSukses.cy.js

describe("Ebupot Unifikasi - GetDetail Upload Sukses", () => {
  beforeEach(() => {
    cy.setupEbupot();
  });

  it("should get detail for Upload Sukses", () => {
    ...
    // Filter status Upload Sukses
    cy.contains("div.badge", "Upload Sukses")
      .should("be.visible")
      .click();
