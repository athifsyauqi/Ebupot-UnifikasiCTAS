...
const createEbupotDraft = () => {
  ...
  cy.contains("#ebupot-unifikasi > div.sub-child", "e-Bupot Unifikasi CTAS")
    .click();
  ...
  cy.wrap(docNumber, { log: false }).as("docNumber");
